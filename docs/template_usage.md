...
Now that your new project repository has been created on github at `https://github.com/scverse/cookiecutter-scverse-instance` you can push your first commit to github.
